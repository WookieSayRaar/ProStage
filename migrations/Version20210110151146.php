 ...
 */
final class Version20210110151146 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, nom VARCHAR(255) NOT NULL, duree VARCHAR(255) NOT NULL, description VARCHAR(500) NOT NULL, date_debut VARCHAR(255) NOT NULL, competences_requises VARCHAR(255) NOT NULL, experience_requise VARCHAR(255) NOT NULL, email VARCHAR(100) NOT NULL, contact VARCHAR(40) NOT NULL, INDEX IDX_C27C9369A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
